...
public class MsgUtil {
	...
	private final static String world_json ="[{\"id\":-10001,\"msg\":\"没有数据\"},{\"id\":-10002,\"msg\":\"超过分配\"},{\"id\":-10003,\"msg\":\"暂时没有玩家\"},{\"id\":-10004,\"msg\":\"当天次数已用完\"},{\"id\":-10005,\"msg\":\"已分配\"}]";
	...
	private final static String army_json ="[{\"id\":-10001,\"msg\":\"还在冷却中\"},{\"id\":-10002,\"msg\":\"部队不存在\"},{\"id\":-10003,\"msg\":\"部队还没有出战\"},{\"id\":-10004,\"msg\":\"已达到最大训练数量\"}]";
