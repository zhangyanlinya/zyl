...
//		renderer.rect(this.getWidth() * 2 + 10, this.getY() + 12, Gdx.graphics.getWidth() / 4, 30);
//		renderer.end();
//		if(percent < 0.2){ 
...
//		renderer.rect(2 + this.getWidth() * 2 + 10, this.getY() + 16, percent * Gdx.graphics.getWidth()/4 - 6, 24);
//		renderer.end();
//		batch.begin();
	}
