...
public abstract class WifiAdmin {
	...
	public List<WifiConfiguration> getWifis(){
		...
		if(list != null){
			for(WifiConfiguration wifiInfo : list){
				System.out.println(" networkId: "+wifiInfo.networkId);
				System.out.println(" BSSID: "+wifiInfo.BSSID);
				System.out.println(" hiddenSSID: "+wifiInfo.hiddenSSID);
				System.out.println(" preSharedKey: "+wifiInfo.preSharedKey);
				System.out.println(" priority: "+wifiInfo.priority);
				System.out.println(" status: "+wifiInfo.status);
				System.out.println(" wepTxKeyIndex: "+wifiInfo.wepTxKeyIndex);
				System.out.println("----------------------------");
			}
		}
		return list;
